...
export default function Projects() {
  return (
    <div style={{ minHeight: "100vh" }} className='bg-red-200 flex flex-wrap justify-around '>
      ...
      <span className='m-10'>
        <Card className="w-96">
          <CardHeader floated={false} className="drop-shadow-2xl hover:rounded-full h-80">
      ...
      <span className='m-10'>
        <Card className="w-96">
          <CardHeader floated={false} className="drop-shadow-xl hover:rounded-full h-80">
      ...
      <span className='m-10'>
        <Card className="w-96">
          <CardHeader floated={false} className="drop-shadow-xl h-80 hover:rounded-full">
